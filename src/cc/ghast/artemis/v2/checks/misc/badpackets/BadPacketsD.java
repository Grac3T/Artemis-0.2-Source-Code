...
extends AbstractCheck {
    ...
    public void handle(PlayerData data, NMSObject packet) {
        ...
        if (packet instanceof WrappedInFlyingPacket) {
            this.sent = false;
        } else if (packet instanceof WrappedInEntityActionPacket && ((action = ((WrappedInEntityActionPacket)packet).getAction()) == WrappedInEntityActionPacket.EnumPlayerAction.START_SPRINTING || action == WrappedInEntityActionPacket.EnumPlayerAction.STOP_SPRINTING)) {
            if (this.sent) {
