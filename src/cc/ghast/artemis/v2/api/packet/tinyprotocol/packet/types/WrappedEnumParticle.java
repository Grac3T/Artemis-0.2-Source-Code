...
public enum WrappedEnumParticle {
    ...
    private WrappedEnumParticle(String name, int value, boolean something) {
        this.name = name;
        this.value = value;
        this.something = something;
    }

    private WrappedEnumParticle(String name, int value, boolean something, int data) {
        this.name = name;
        this.value = value;
        this.something = something;
        this.data = data;
    ...
    public static WrappedEnumParticle getByName(String name) {
        return Arrays.stream(WrappedEnumParticle.values()).filter(val -> val.getName().equalsIgnoreCase(name)).findFirst().orElse(null);
    }

    public Object toNMS() {
        return Reflections.getNMSClass("EnumParticle").getEnum(WrappedEnumParticle.getByName(this.name).name());
    }
